...
balance/interfaces: Please view: https://github.com/Nghiait123456/HighPerformancePaymentGateway-BalanceService/tree/master/balance/interfaces </br>
...
## DTO <a name="DTO"></a>
balance/interfaces/controller/dto : please view: https://github.com/Nghiait123456/HighPerformancePaymentGateway-BalanceService/tree/master/balance/interfaces/controller/dto </br>
In the web world, all services communicate with each other using api. An api will consist of the two most important parts, the collection of all inputs and the collection of all outputs. To clarify this problem in the layout code, to be able to deploy code independent of the api running protocol, a common design pattern is: DTO. </br>
In this design, I split into 2 dtos for request and response, all input and ouput data of the api must be based on these 2 layers. DTO should have a simple logic, simple code processing, independent and not dependent on any other layout in the project. Imagine it as the beginning and the end of a river, the river is like the logical flow of your service. </br>


## API Interface <a name="APIInterface"></a>
balance/interfaces/controller/api: please view: https://github.com/Nghiait123456/HighPerformancePaymentGateway-BalanceService/tree/master/balance/interfaces/controller/api </br>
...
balance/interfaces/controller/web: please view: https://github.com/Nghiait123456/HighPerformancePaymentGateway-BalanceService/tree/master/balance/interfaces/controller/web </br>
...
balance/pkg: please view: https://github.com/Nghiait123456/HighPerformancePaymentGateway-BalanceService/tree/master/balance/pkg </br>
...
balance/application: please view: https://github.com/Nghiait123456/HighPerformancePaymentGateway-BalanceService/tree/master/balance/application </br>
...
balance/application/service.go: Please view: https://github.com/Nghiait123456/HighPerformancePaymentGateway-BalanceService/blob/master/balance/application/service.go
...
![](img/value_object.png) </br>
/balance/value_object: Please view: https://github.com/Nghiait123456/HighPerformancePaymentGateway-BalanceService/tree/master/balance/value_object </br>
...
balance/module.go: please view: https://github.com/Nghiait123456/HighPerformancePaymentGateway-BalanceService/blob/master/balance/module.go.
...
- thamk khao layout stand , tach ra k gop vao nua
